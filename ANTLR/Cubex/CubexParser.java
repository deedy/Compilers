...
public class CubexParser extends Parser {
	...
	public static final int
		RANGEOP=25, MODULO=11, CLASS=2, LT=14, RBRACE=34, WHILE=6, PLUSPLUS=26, 
		LBRACE=33, ELSE=8, GTE=17, BOOL=39, NEGATE=22, INT=38, SEMICOLON=32, MINUS=13, 
		AND=20, LTE=16, LPAREN=29, TYPE=35, IF=7, COLON=27, RPAREN=30, NAME=36, 
		WS=37, IN=9, COMMA=31, EQUAL=28, OR=21, RETURN=10, GT=15, PLUS=12, INTERFACE=1, 
		SUPER=4, EQ=18, COMMENT=40, FUN=5, TIMES=23, EXTENDS=3, DIVIDE=24, STRING=41, 
		NE=19;
	...
	public final SymbolContext symbol() throws RecognitionException {
		...
		try {
			...
			setState(38);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << MODULO) | (1L << PLUS) | (1L << MINUS) | (1L << LT) | (1L << GT) | (1L << LTE) | (1L << GTE) | (1L << EQ) | (1L << NE) | (1L << AND) | (1L << OR) | (1L << NEGATE) | (1L << TIMES) | (1L << DIVIDE) | (1L << RANGEOP) | (1L << PLUSPLUS) | (1L << COLON) | (1L << EQUAL) | (1L << LPAREN) | (1L << RPAREN) | (1L << COMMA) | (1L << SEMICOLON) | (1L << LBRACE) | (1L << RBRACE))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public static final String _serializedATN =
		...
		"\2\2\2\36\37\7&\2\2\37\t\3\2\2\2 !\7)\2\2!\13\3\2\2\2\"#\7(\2\2#\r\3\2"+
		"\2\2$%\7\'\2\2%\17\3\2\2\2&\'\t\2\2\2\'\21\3\2\2\2()\t\3\2\2)\23\3\2\2"+
